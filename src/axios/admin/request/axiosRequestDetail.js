...
const URL = `${baseUrl}/admin/requestdetail/`
...
const getDataByReqNoDetail = async (id, cb) => {
  try {
    let dataById = await axios({
      method: 'GET',
      url: `${URL}reqno/${id}`,
...
export { getAllRequest, getDataById, addData, deleteData, updateData, getDataByReqNoDetail }
