...
import { getAllData, deleteData, addData, getDataById, updateData } from 'src/axios/axiosDamage'

const Damage = () => {
  // Get All Data
  const [damage, setDamage] = useState([])
  useEffect(() => {
    getAllData((res) => setDamage(res))
  }, [])
  ...
  return (
    <>
              ...
              <CTable align="middle" className="mb-0 border" striped>
                ...
                <CTableHead color="dark">
                  <CTableRow>
                    ...
                    <CTableHeaderCell className="text-center">Damage Name</CTableHeaderCell>
      ...
      >
        <CModalHeader>
          <CModalTitle>Edit Damage Name</CModalTitle>
        </CModalHeader>
        <CModalBody>
          <CFormInput
            type="text"
